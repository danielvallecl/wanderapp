...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { aux1: @preference.aux1, obs: @preference.obs, options: @preference.options, user_id: @preference.user_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { aux1: @preference.aux1, obs: @preference.obs, options: @preference.options, user_id: @preference.user_id } }
